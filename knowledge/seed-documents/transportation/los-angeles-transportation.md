...
confidence: medium
tags: los-angeles,transportation,world-cup-2026,football,travel

## Matchday Transportation

Primary transportation context for Los Angeles: LA Metro rail and bus connections, event shuttles, rideshare staging and freeways. Fans should plan by travel corridor and time of day, not by map distance alone. The transportation document should ground mode choice and movement constraints, not compute a full route or live travel time. Stadium travel should be framed around SoFi Stadium in Inglewood and the visitor districts Inglewood, Downtown LA, Koreatown, Santa Monica, Hollywood.
...
Official or stable sources used for grounding include FIFA host/stadium pages, https://www.sofistadium.com/, https://www.discoverlosangeles.com/, and https://www.metro.net/. Transit agency names, stadium geography, and broad mode availability are stable source-backed facts. Service frequency, road closures, shuttle operations, and disruptions are volatile and must not be invented.
