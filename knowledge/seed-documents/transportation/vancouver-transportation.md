...
confidence: medium
tags: vancouver,transportation,world-cup-2026,football,travel

## Matchday Transportation

Primary transportation context for Vancouver: SkyTrain, SeaBus, downtown buses, walkable waterfront corridors. SkyTrain and walking are strong defaults, with post-match pressure around downtown stations. The transportation document should ground mode choice and movement constraints, not compute a full route or live travel time. Stadium travel should be framed around BC Place in Vancouver and the visitor districts Yaletown, Gastown, False Creek, Granville Street, Coal Harbour.
...
Official or stable sources used for grounding include FIFA host/stadium pages, https://www.bcplace.com/, https://www.destinationvancouver.com/, and https://www.translink.ca/. Transit agency names, stadium geography, and broad mode availability are stable source-backed facts. Service frequency, road closures, shuttle operations, and disruptions are volatile and must not be invented.
